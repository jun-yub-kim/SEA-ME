    ...
    : m_nickname(QLatin1String("nickname"))
{
    ...
    QDBusConnection::sessionBus().connect(QString(), QString(), "org.example.CarExample", "message", this, SLOT(messageSlot(QString,QString)));
...
void ChatMainWindow::sendClickedSlot()
{
    ...
    QDBusMessage msg = QDBusMessage::createSignal("/", "org.example.CarExample", "message");
